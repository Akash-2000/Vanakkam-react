  ...
  return (
    <>
      <div className="bg-gray-300 p-4">
        <input className="p-2 rounded-md" onChange={(e) => setSearchText(e.target.value)}></input>
        <button className="bg-pink-300 px-4 py-2 rounded-md ml-2 text-black" onClick={handleSearch}>Search</button>
      </div>
