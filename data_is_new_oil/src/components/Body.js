  ...
  return (
    <>
      <div className="mx-7 p-4">
        <input className="p-2 rounded-md border border-black" onChange={(e) => setSearchText(e.target.value)}></input>
        <button className="bg-green-200 px-4 py-2 rounded-md ml-2 text-black" onClick={handleSearch}>Search</button>
      </div>
